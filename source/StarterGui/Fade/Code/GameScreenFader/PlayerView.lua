...
local View = {}
View.__index = View
View.className = "GameScreenFaderView"
...
function View:handleScreenFader()
    ...
    self._maid:Add(playerGameState:getEvent(S.Session, "ScreenFader", "fadeIn"):Connect(fadeIn))
    self._maid:Add(playerGameState:getEvent(S.Session, "ScreenFader", "fadeOut"):Connect(fadeOut))
    local state = playerGameState:get(S.Session, "ScreenFader")
