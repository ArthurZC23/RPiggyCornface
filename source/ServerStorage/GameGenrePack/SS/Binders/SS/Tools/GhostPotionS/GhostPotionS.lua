...
local GhostPotionS = {}
GhostPotionS.__index = GhostPotionS
GhostPotionS.className = "GhostPotion"
GhostPotionS.TAG_NAME = GhostPotionS.className

function GhostPotionS.new(Tool)
    local self = {
        Tool = Tool,
        _maid = Maid.new(),
    }
    setmetatable(self, GhostPotionS)
...
function GhostPotionS:setItemCFrame()
    local maid = Maid.new()
...
function GhostPotionS:activated()
    self:consume()
end

function GhostPotionS:deactivated()

end

function GhostPotionS:getFields()
