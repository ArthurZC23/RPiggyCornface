...
local SpeedPotionS = {}
SpeedPotionS.__index = SpeedPotionS
SpeedPotionS.className = "SpeedPotion"
SpeedPotionS.TAG_NAME = SpeedPotionS.className

function SpeedPotionS.new(Tool)
    local self = {
        Tool = Tool,
        _maid = Maid.new(),
    }
    setmetatable(self, SpeedPotionS)
...
function SpeedPotionS:setItemCFrame()
    local maid = Maid.new()
...
function SpeedPotionS:activated()
    self:consume()
end

function SpeedPotionS:deactivated()

end

function SpeedPotionS:getFields()
