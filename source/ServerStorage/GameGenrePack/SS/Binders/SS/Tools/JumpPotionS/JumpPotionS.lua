...
local JumpPotionS = {}
JumpPotionS.__index = JumpPotionS
JumpPotionS.className = "JumpPotion"
JumpPotionS.TAG_NAME = JumpPotionS.className

function JumpPotionS.new(Tool)
    local self = {
        Tool = Tool,
        _maid = Maid.new(),
    }
    setmetatable(self, JumpPotionS)
...
function JumpPotionS:setItemCFrame()
    local maid = Maid.new()
...
function JumpPotionS:activated()
    self:consume()
end

function JumpPotionS:deactivated()

end

function JumpPotionS:getFields()
