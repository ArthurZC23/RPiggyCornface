...
export type pxMin = number

export type pxMax = number
...
local Subcategories = {
	...
	["Building"] = 48,
	["Transport"] = 49,
    ["HeadAccessories"] = 54, --Accessories > Head
}
...
function ParseParameters(Parameters: SearchParams)
	local ParsedParams: SearchParams = {
        ...
        pxMin = Parameters.pxMin,
        pxMax = Parameters.pxMax,
...
function ScrapeCatalogAssets(Parameters: SearchParams,Amount: number?,Assets: {any}?,LogOutput: boolean | nil)
	...
	local Success,Response = pcall(function()
        local url = CatalogSearchUrl.."?"..ConvertParamDictionaryToString(Parameters)
        -- print(url)
