...
module.scoreTypes = Mts.makeEnum("PlayerSessionScoreNameToId", module.scores.nameToId)
...
module.idToData = Mts.makeEnum("PlayerSessionScoreIdToName", module.scores.nameToId)
