...
local SpinBlockClientC = {}
SpinBlockClientC.__index = SpinBlockClientC
SpinBlockClientC.className = "SpinBlockClient"
SpinBlockClientC.TAG_NAME = SpinBlockClientC.className

function SpinBlockClientC.new(inst)
    local self = {
        inst = inst,
        _maid = Maid.new(),
    }
    setmetatable(self, SpinBlockClientC)
...
function SpinBlockClientC:spin()
...
function SpinBlockClientC:getFields()
...
function SpinBlockClientC:Destroy()
    self._maid:Destroy()
end

return SpinBlockClientC