...
local CharCoreAnimationsMonster = {}
CharCoreAnimationsMonster.__index = CharCoreAnimationsMonster
CharCoreAnimationsMonster.className = "CharCoreAnimationsMonster"
CharCoreAnimationsMonster.TAG_NAME = CharCoreAnimationsMonster.className

function CharCoreAnimationsMonster.new(char)
    ...
    setmetatable(self, CharCoreAnimationsMonster)
...
function CharCoreAnimationsMonster:setParameters()
...
function CharCoreAnimationsMonster:getRigScale()
...
function CharCoreAnimationsMonster:preloadCoreAnimations()
...
function CharCoreAnimationsMonster:getPoseData(pose)
...
function CharCoreAnimationsMonster:getPoseAnimSignal(pose)
    return self[("%sUpdateSE"):format(pose)]
end

function CharCoreAnimationsMonster:setPoseAnimations(pose, poseStyle, animationsData, kwargs)
...
function CharCoreAnimationsMonster:removePoseAnimation(pose, animationId, kwargs)
    local poseAnims = self.animationsFolder[pose]
...
function CharCoreAnimationsMonster:setInitialPoseToAnims()
...
function CharCoreAnimationsMonster:createSignals()
...
function CharCoreAnimationsMonster:clearCoreAnimations()
...
function CharCoreAnimationsMonster:createAnimationsFolder()
...
function CharCoreAnimationsMonster:getFields()
    local ok = SharedSherlock:find({"WaitFor", "Val"}, {
        getter=function()
            ...
            self.charAnimations = self.charAnimations
...
function CharCoreAnimationsMonster:configureAnimationSet(poseName, animationsData)
...
function CharCoreAnimationsMonster:configureAllAnimationSet()
...
function CharCoreAnimationsMonster:setRunSpeed(speed)
...
function CharCoreAnimationsMonster:setAnimationSpeed(speed)
...
function CharCoreAnimationsMonster:stopAllAnimations()
...
function CharCoreAnimationsMonster:getHeightScale()
...
function CharCoreAnimationsMonster:rootMotionCompensation(speed)
...
function CharCoreAnimationsMonster:keyFrameReachedFunc(frameName)
...
function CharCoreAnimationsMonster:_sampleAnimation(animName)
    -- TableUtils.print(self.animTable)
    -- print(animName)
...
-- Preload animations
function CharCoreAnimationsMonster:playAnimation(animName, transitionTime)
...
function CharCoreAnimationsMonster:toolKeyFrameReachedFunc(frameName)
	if (frameName == "End") then
...
function CharCoreAnimationsMonster:playToolAnimation(animName, transitionTime, priority)
    local newAnimation = self:_sampleAnimation(animName)
...
function CharCoreAnimationsMonster:stopToolAnimations()
...
function CharCoreAnimationsMonster:onRunning(speed)
...
function CharCoreAnimationsMonster:onDied()
	self.pose = "Dead"
end

function CharCoreAnimationsMonster:onJumping()
	self:playAnimation("jump", 0.1)
	self.jumpAnimTime = self.jumpAnimDuration
	self.pose = "Jumping"
end

function CharCoreAnimationsMonster:onClimbing(speed)
	if self.userAnimateScaleRun then
...
function CharCoreAnimationsMonster:onGettingUp()
	self.pose = "GettingUp"
end

function CharCoreAnimationsMonster:onFreeFall()
...
function CharCoreAnimationsMonster:onFallingDown()
	self.pose = "FallingDown"
end

function CharCoreAnimationsMonster:onSeated()
	self.pose = "Seated"
end

function CharCoreAnimationsMonster:onPlatformStanding()
	self.pose = "PlatformStanding"
end

function CharCoreAnimationsMonster:onSwimming(speed)
	if self.userAnimateScaleRun then
		speed /= self:getHeightScale()
	end
	if speed > 1.00 then
...
function CharCoreAnimationsMonster:getTool()
    return self.char:FindFirstChildOfClass("Tool")
end

function CharCoreAnimationsMonster:getToolAnim(tool)
...
function CharCoreAnimationsMonster:animateTool()
...
function CharCoreAnimationsMonster:move(timestamp)
...
function CharCoreAnimationsMonster:setHumanoidEvents()
...
function CharCoreAnimationsMonster:Destroy()
    self._maid:Destroy()
    self.isBinded = false
    self:clearCoreAnimations()
end

return CharCoreAnimationsMonster