...
local actionsPerStateType = {
    Session = ActionsLoader.load(ReplicatedStorage.Actions.Player.Session.Actions),
    Stores = ActionsLoader.load(ReplicatedStorage.Actions.Player.Stores.Actions),
    LocalSession = ActionsLoader.load(ReplicatedStorage.Actions.Player.LocalSession.Actions),
}
